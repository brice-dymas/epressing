...
public class CaracteristiqueResource {
    ...
    public CaracteristiqueResource(CaracteristiqueService caracteristiqueService) {
    ...
    public ResponseEntity<Caracteristique> createCaracteristique(@Valid @RequestBody Caracteristique caracteristique) throws URISyntaxException {
        ...
        if (caracteristique.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new caracteristique cannot already have an ID")).body(null);
        }
    ...
    public ResponseEntity<Caracteristique> updateCaracteristique(@Valid @RequestBody Caracteristique caracteristique) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, caracteristique.getId().toString()))
            .body(result);
    }
    ...
    @Timed
    public ResponseEntity<List<Caracteristique>> getAllCaracteristiques(@ApiParam Pageable pageable)
    ...
    public ResponseEntity<Caracteristique> getCaracteristique(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(caracteristique));
    }
    ...
    @Timed
    public ResponseEntity<List<Caracteristique>> searchCaracteristiques(@RequestParam String query, @ApiParam Pageable pageable)
        throws URISyntaxException {
